...
WebUI.setText(findTestObject('Home Page/Login username field'), 'WrongUsername')
...
WebUI.verifyElementText(findTestObject('Home Page/Error message on wrong credentials'), 'Грешен потребител / парола.')
